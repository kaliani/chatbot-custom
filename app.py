...
if agent_selection == "Agent 1":
    ...
    run_csv_agent('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', uploaded_file)
elif agent_selection == "Agent 2":
    uploaded_file = st.file_uploader("**Upload Your PDF File**", type=["pdf"])
    run_pdf_agent('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', uploaded_file)
elif agent_selection == "Agent 3":
    text_input = st.text_area("Enter text for summarization", height=200)
    if st.button("Summarize"):
        summary = run_summarize_agent('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', text_input)
